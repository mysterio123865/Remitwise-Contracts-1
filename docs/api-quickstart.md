...
This note documents the **api-quickstart** of the remitflow-contract contract.

remitflow-contract is a Soroban smart contract on the Stellar network. This page is part of the
project's reference documentation and describes the api-quickstart in detail, covering the relevant
